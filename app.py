...
if page == "Homepage":
    ...
    st.image("https://i.pinimg.com/736x/43/c9/65/43c9653e3a717d4a80a0551ebec6c978.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
...
# Contact Us
    ...
    with st.form("contact_form"):
        name = st.text_input("pete")
        email = st.text_input("vuthimedh@gmail.com")
        message = st.text_area("Hi")
